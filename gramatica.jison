...
instruccion
	...
	| RSET IDENTIFICADOR PTCOMA						{ $$ = instruccionesAPI.nuevoDeclaracion($2, TIPO_DATO.SET); }
...
expresion_cadena
	...
	| BOOLEAN											{ $$ = instruccionesAPI.nuevoValor($1, TIPO_VALOR.BOOLEAN); }
